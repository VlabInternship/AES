...
// the input is mapped to its multiplicative inverse in GF(28) = GF(2) [x]/(x8 + x4 + x3 + x + 1),
export const SBOX = [
...
export const INV_SBOX_INDEXED = Array.from({ length: 17 }, (_, row) =>
  Array.from({ length: 17 }, (_, col) => {
    ...
    return INV_SBOX[index].toString(16).toUpperCase().padStart(2, '0');
  })
);
