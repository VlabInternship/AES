...
const Step2InitialPermutationAndSplit = ({ inputBits, permutedBits }) => {
  ...
  if (hoveredKey && coordMap[hoveredKey] !== undefined) {
    ...
    if (permutedIndex < 32) {
      // Bit goes to L₀
      const l0Row = Math.floor(permutedIndex / 8);
      const l0Col = permutedIndex % 8;
      l0HighlightMap[`${l0Row}-${l0Col}`] = 'result';
    } else {
      // Bit goes to R₀
  ...
  return (
    ...
    >
      ...
      <div className="explanation-box">
        <p>
          <strong>Initial Permutation (IP):</strong> The 64-bit plaintext block is permuted according to the IP table.
        ...
        <p style={{ fontSize: '0.9em', color: '#666' }}>
          <strong>Hover over any bit in the original plaintext to see:</strong>
          <br />
      ...
      <div className="step-row-grid">
        <div className="step-box">
          <h4 className="title">Original Plaintext (64 bits)</h4>
          <MatrixTable
      ...
      <div className="legend-box" style={{ fontSize: '0.9rem', textAlign: 'center' }}>
        <span style={{ color: 'goldenrod' }}>🟨 Yellow = Hovered bit in original plaintext</span> &nbsp;|&nbsp;
