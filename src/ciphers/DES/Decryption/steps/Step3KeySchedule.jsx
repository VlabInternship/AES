...
import { prepareKeyScheduleMatrixReversed, getCDHalvesPerRound, applyPC1WithTrace, getBeforePC1PerRound, applyPC2WithTrace } from '../../../../shared/des/keyScheduleHelper';
...
const Step3KeySchedule = ({ keyBits, onKeysGenerated }) => {
  ...
  useEffect(() => {
    if (keyBits?.length === 64) {
      const keys = prepareKeyScheduleMatrixReversed(keyBits);
    ...
    >
      ...
      <div className="explanation-box">
        <p>
          ...
          Each round key is used in the Feistel network to decrypt the ciphertext.
        </p>
        <p>
